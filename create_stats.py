    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "8px" }}>
        {[
          ...
          { label: "Este ano",  value: formatGrams(stats.totalAnio),      sub: `#${stats.posicionAnio} del club` },
...
with open("src/app/mi-perfil/StatsGamificados.tsx", "w", encoding="utf-8") as f:
    f.write(content)
