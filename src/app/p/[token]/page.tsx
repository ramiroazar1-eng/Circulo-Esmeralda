    ...
    <div style={{ minHeight: "100vh", background: "#080f09", color: "white", fontFamily: "system-ui, sans-serif", paddingBottom: "32px" }}>
      ...
      <div style={{ background: "#0f2412", padding: "32px 20px 20px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", flexWrap: "wrap" }}>
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: isActive ? "rgba(34,197,94,0.1)" : "rgba(239,68,68,0.1)", border: `1px solid ${isActive ? "rgba(34,197,94,0.3)" : "rgba(239,68,68,0.3)"}`, borderRadius: "20px", padding: "4px 14px", fontSize: "11px", color: isActive ? "#4ade80" : "#f87171", fontWeight: 600 }}>
            <span style={{ width: "5px", height: "5px", borderRadius: "50%", background: isActive ? "#4ade80" : "#f87171", display: "inline-block" }} />
            {isActive ? "Socio activo" : "Socio inactivo"}
          </div>
        </div>
        {stats.primeraDispensa && <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.25)", marginTop: "8px", marginBottom: 0 }}>Miembro desde {formatDate(stats.primeraDispensa)}</p>}
      </div>
      ...
      <div style={{ padding: "12px 16px 0", display: "flex", flexDirection: "column", gap: "12px", maxWidth: "400px", margin: "0 auto" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", padding: "14px" }}>
          ...
          <p style={{ fontSize: "10px", color: "rgba(255,255,255,0.25)", marginTop: "6px", textAlign: "right", marginBottom: 0 }}>{formatGrams(stats.totalHistorico)} totales</p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "8px" }}>
          {[
            ...
            <div key={i} style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "14px", padding: "12px 8px", textAlign: "center" }}>
              <p style={{ fontSize: "10px", color: "rgba(255,255,255,0.35)", marginBottom: "4px", textTransform: "uppercase", letterSpacing: "1px", margin: "0 0 4px" }}>{s.label}</p>
              <p style={{ fontSize: "16px", fontWeight: 800, color: "white", lineHeight: 1, margin: 0 }}>{s.value}</p>
              <p style={{ fontSize: "10px", color: "#4d7a46", marginTop: "4px", margin: "4px 0 0" }}>{s.sub}</p>
            </div>
          ))}
        </div>
